...
public class GarKutipKch1Tambah extends AppCompatActivity {
    static final String TAG = GarKutipKch1Tambah.class.getSimpleName();
    ...
    private String url = Server.URL + "garkutipkch1/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_kutip_kch1_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarKutipKch1Tambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarKutipKch1");
                        finish();
