...
public class GarPreheatingTambah extends AppCompatActivity {
    static final String TAG = GarPreheatingTambah.class.getSimpleName();
    ...
    private String url = Server.URL + "garpreheating/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_preheating_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarPreheatingTambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarPreheating");
                        finish();
