...
public class GarKutip2Tambah extends AppCompatActivity {
    static final String TAG = GarKutip2Tambah.class.getSimpleName();
    ...
    private String url = Server.URL + "garkutip2/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_kutip2_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarKutip2Tambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarKutip2");
                        finish();
