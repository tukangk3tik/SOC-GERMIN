...
public class GarFungisidaTambah extends AppCompatActivity {
    static final String TAG = GarFungisidaTambah.class.getSimpleName();
    ...
    private String url = Server.URL + "garfungisida/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_fungisida_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarFungisidaTambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarFungisida");
                        finish();
