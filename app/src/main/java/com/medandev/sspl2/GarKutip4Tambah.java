...
public class GarKutip4Tambah extends AppCompatActivity {
    static final String TAG = GarKutip1Tambah.class.getSimpleName();
    ...
    private String url = Server.URL + "garkutip4/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_kutip4_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarKutip4Tambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarKutip4");
                        finish();
