...
public class GarKutip1Tambah extends AppCompatActivity {
    ...
    private String url = Server.URL + "garkutip1/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_kutip1_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarKutip1Tambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarKutip1");
                        finish();
