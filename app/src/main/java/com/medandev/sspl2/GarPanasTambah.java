...
public class GarPanasTambah extends AppCompatActivity {
    static final String TAG = GarPanasTambah.class.getSimpleName();
    ...
    private String url = Server.URL + "garpanas/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_panas_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarPanasTambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarPanas");
                        finish();
