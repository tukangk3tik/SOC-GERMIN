...
public class GarGelap2Tambah extends AppCompatActivity {
    static final String TAG = GarGelap2Tambah.class.getSimpleName();
    ...
    private String url = Server.URL + "gargelap2/aksi.php?act=tambah";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gar_gelap2_tambah);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Intent intent = new Intent(GarGelap2Tambah.this, MainActivity.class);

                        intent.putExtra("fragmentActive", "GarGelap2");
                        finish();
